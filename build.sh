...
[ -z $LTO ] && LTO=none
[ -z $DEFAULT_KSU_REPO ] && DEFAULT_KSU_REPO="https://raw.githubusercontent.com/SukiSU-Ultra/SukiSU-Ultra/builtin/kernel/setup.sh"
[ -z $DEFAULT_KSU_BRANCH ] && DEFAULT_KSU_BRANCH="builtin"
